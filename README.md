...
> 📼 演示录制中（参见 [`assets/README.md`](./assets/README.md) 了解如何用 vhs 重新生成）。
> tape 脚本：[`assets/demo.tape`](./assets/demo.tape) ｜ 时长目标 30 秒。
...
- [ ] **m3** — `skillsig diff old/ new/` + `~/.skillsig/lock.yaml` 跨版本漂移
